...
// WithError applies the provided err to the *Error,
// Err should be a standard error but does not need to be, this method is useful when constructing a *Error at the beginning of a function call
// and then setting the Err field later.
